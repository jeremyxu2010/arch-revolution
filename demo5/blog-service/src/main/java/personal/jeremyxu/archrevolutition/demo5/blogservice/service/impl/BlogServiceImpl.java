package personal.jeremyxu.archrevolutition.demo5.blogservice.service.impl;
...
import personal.jeremyxu.archrevolutition.demo5.blogservice.repository.BlogRepository;
import personal.jeremyxu.archrevolutition.demo5.blogservice.service.BlogService;

import java.util.*;

import static personal.jeremyxu.archrevolutition.demo5.blogservice.config.QueueConfig.BLOG_EVNETS_QUEUE_NAME;
...
public class BlogServiceImpl implements BlogService {
    ...
    public void save(Blog blog) {
        ...
        // 通过消息队列发送数据变更事件
        this.rabbitTemplate.convertAndSend(BLOG_EVNETS_QUEUE_NAME, "BlogCreatedOrUpdated");
    }
    ...
    public void deleteById(int blogId) {
        ...
        // 通过消息队列发送数据变更事件
        this.rabbitTemplate.convertAndSend(BLOG_EVNETS_QUEUE_NAME, "BlogDeleted");
    }
    ...
    public void deleteByUserId(Integer userId) {
        ...
        // 通过消息队列发送数据变更事件
        this.rabbitTemplate.convertAndSend(BLOG_EVNETS_QUEUE_NAME, "MultipleBlogDeleted");
    }
}
